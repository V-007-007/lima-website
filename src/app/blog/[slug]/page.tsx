...
// Fix: Make params async in Next.js 15
      ...
      <article>
        ...
        <AnimatedSection className="section-padding">
          <div className="section-container max-w-4xl">
            <div 
              className="prose prose-lg max-w-none prose-headings:font-bold prose-h2:text-3xl prose-h2:mt-8 prose-h2:mb-4 prose-p:text-gray-700 prose-p:leading-relaxed prose-ul:list-disc prose-ul:ml-6 prose-li:text-gray-700"
            ...
            <div className="mt-12 text-center">
              ...
              <div className="flex justify-center space-x-4">
                ...
                <button className="btn-secondary">Share on Facebook</button>
              </div>
            </div>
          </div>
        </AnimatedSection>
